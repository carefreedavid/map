...
/* var of drawn polygon */
draw = new google.maps.Polygon(RandburgCoords);
/* set polygon to map */
draw.setMap(map);

/* if statement using 'contains' to check */
if(google.maps.geometry.poly.containsLocation(spoint, draw) == true) {
  return "Randburg";
}
else{
  return "nope"
...
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAkIVv5Rykv3MWoSqXM9KBW3aSaCfZT_Is&libraries=geometry&callback=initMap">
